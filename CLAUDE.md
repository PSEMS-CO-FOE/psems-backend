...
## Current phase
Week 1 of the roadmap: repo/Docker foundation (done), Prisma schema v1 (users, students, lecturers, course_instances, cpi_timelines), JWT+bcrypt auth with forced first-login password change, RBAC middleware skeleton, CI skeleton.
