...
// Same-site by default; COOKIE_SAMESITE=none only when the SPA and API sit on
// unrelated domains. No maxAge here: clearCookie merges these over its own
// expiry, and a maxAge would re-issue the cookie instead of clearing it.
